...
The Windows Server service (`LanmanServer`) was confirmed to be running, supporting the expected SMB/Windows networking functionality associated with port 445.
